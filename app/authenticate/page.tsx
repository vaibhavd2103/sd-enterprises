...
function Authenticate() {
  ...
  const getAllManagers = async (value: string) => {
    try {
      const res = await GET_ALL_RETAILERS();
      if (res.data.status === "success") {
        const arr = res.data.data.map((item) => ({
          label: item.name,
          value: item._id,
  ...
  const handleDebounceSearch = (value: string) => {
    ...
    return new Promise<any>(async (resolve) => {
      timeout.current = setTimeout(async () => {
        const managers = await getAllManagers(value);
        resolve(managers);
      }, 1000);
    });
  };
    ...
    <div className="flex w-screen h-screen justify-center">
      ...
      <div className="flex flex-col justify-center items-center w-[100%] md:w-[50%]">
        <div className="max-w-[470px] w-[100%] flex flex-col items-center">
          ...
          <div className="flex flex-row w-[80%] md:w-[80%] justify-evenly mb-2">
            <div
          ...
          {method === "LOGIN" ? (
            <div className="flex flex-col gap-[20px] w-[80%] items-center">
              {/* ------------------------------------------------------------------------------------------------------------------- */}
              <div className="w-[100%]">
